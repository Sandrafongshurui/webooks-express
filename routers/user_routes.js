...
router.get('/loan/:id', authMiddleware, userController.openBook)//return {}
...
router.post('/loan/:bookId', authMiddleware, userController.createLoan)//returns 201
router.post('/reserve/:bookId', authMiddleware, userController.createReserve) //returns 201
router.post('/favourite/:bookId', authMiddleware, userController.createFavourite)
